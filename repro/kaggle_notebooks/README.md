...
|---|---|---|---|
| `antmaze_ablation.ipynb` | AntMaze-v1 (long-horizon, PRIMARY) | `antmaze_s221_paper` | notebook train AntMaze |
| `fetch_ablation.ipynb` | FetchPickAndPlace-v1 (short-horizon, control) | `fetch_s967` | notebook train Fetch |

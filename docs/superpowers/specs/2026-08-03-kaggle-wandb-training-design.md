...
- `checkpoint`: the saved checkpoint path and step.
- `final`: final model path, final evaluation metrics, and success rate.
...
resolved L3P configuration fields plus launcher arguments.
